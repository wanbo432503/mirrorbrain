  ...
  it('assembles the service, API contract, static assets, and HTTP server into one dev runtime', async () => {
    ...
    const createMirrorBrainService = vi.fn(() => ({
      ...
      reviseKnowledgeArticle: vi.fn(async () => ({
        article: {
          id: 'knowledge-article:article-project-example-topic-example-example:v2',
          articleId: 'article:project-example:topic-example:example',
          projectId: 'project:example',
          topicId: 'topic:example',
          title: 'Example',
          ...
          version: 2,
          isCurrentBest: true,
          supersedesArticleId: 'knowledge-article:article-project-example-topic-example-example:v1',
          sourceReviewedWorkSessionIds: [],
          sourceMemoryEventIds: [],
          provenanceRefs: [],
          publishState: 'published' as const,
        ...
        createMirrorBrainService: vi.fn(() => ({
          ...
          reviseKnowledgeArticle: vi.fn(async () => ({
            article: {
              ...
              isCurrentBest: true,
              supersedesArticleId:
                'knowledge-article:article-project-example-topic-example-example:v1',
              sourceReviewedWorkSessionIds: [],
              sourceMemoryEventIds: [],
              provenanceRefs: [],
              publishState: 'published' as const,
