...
- generates and publishes Phase 4 Knowledge Article Drafts from reviewed work sessions
...
15. Generate Knowledge Article Drafts from reviewed work sessions and persist them in the article store.
16. Publish Knowledge Article Drafts under a project/topic, saving current-best versions and any superseded prior version.
...
- unit tests verify reviewed work sessions can generate Knowledge Article Drafts and publish current-best article versions with history
