  ...
  if (items.length === 0) {
    return (
      <Card className="max-h-[540px] overflow-y-auto">
        <div>
          <p className="text-xs font-heading font-semibold text-slate-600 uppercase tracking-wide mb-3">
            {title}
          </p>
          <EmptyState
  ...
  return (
    <Card className="max-h-[540px] overflow-y-auto">
      <div className="space-y-3">
        {/* Title */}
        <p className="text-xs font-heading font-semibold text-slate-600 uppercase tracking-wide">
          {title}
        </p>
